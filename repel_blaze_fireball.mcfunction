...
#Reflect East
execute @s ~2 ~6 ~-1 execute @e[type=small_fireball,name=toBeReflected,dx=4,dy=-12,dz=2] ~ ~ ~ summon minecraft:small_fireball ~ ~ ~  {direction:[0.1,-0.01,0.0],power:[0.1,-0.01,0.0]}
