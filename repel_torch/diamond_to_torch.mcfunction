...
execute @e[name=item.item.diamond,tag=WATER] ~ ~ ~ give @p[score_dropDiamond_min=1] minecraft:armor_stand 1 0 {HideFlags:1,ench:[{id:34,lvl:1}],display:{Name:"Interdiction Torch",Lore:["Repels hostile mobs,","arrows, and ghast","fireballs in a 6 block","radius."]},EntityTag:{Invisible:1b,Invulnerable:1b,NoGravity:1b,Marker:1b,CustomName:"torchMainNew"}}
